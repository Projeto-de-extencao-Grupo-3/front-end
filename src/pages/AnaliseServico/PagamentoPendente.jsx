...
function PagamentoPendente() {
  ...
  const ticket = {
    ...
    itens: [
      { id: 1, codigo: "00024", item: "Tinta Azul-Fiap", visibilidade: "Privado", quantidade: 8, preco: 30, status: "Concluido" },
      { id: 2, codigo: "00025", item: "Primer", visibilidade: "Privado", quantidade: 10, preco: 30, status: "Pendente" }
    ]
  };
      ...
      <div className="container-principal">
        ...
        <div className="layout-grid">
          ...
          <div className="coluna-acoes">
            ...
            <button className="btn-concluir">$ Concluir Pagamento</button>
