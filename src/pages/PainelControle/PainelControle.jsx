                        ...
                        {servicos.filter(item => item.status === "EM_PRODUCAO").map((servico) => (
                            <ServicoCard cor="verde" key={servico.id_ordem_servico}>
                                ...
                                <div className="d-flex align-items-center gap-1">
                                    ...
                                    {servico.veiculo.modelo} ({servico.veiculo.ano_modelo})
                                </div>
                                <div><strong>Placa:</strong> {servico.veiculo.placa}</div>
                ...
                {kpiAtiva === 'autorizacao' && (
                    <div className="d-flex flex-wrap gap-5 justify-content-start">
                        <ServicoCard cor="verde">
                            <strong className="d-flex align-items-center gap-2">Viação Gontijo</strong>
                        ...
                        <ServicoCard cor="amarelo">
                            ...
                            <div className="d-flex align-items-center gap-1"><i className='bx bxs-bus' style={{ fontSize: "22px" }}></i> Irizar i6 - 1400</div>
                        ...
                        <ServicoCard cor="verde">
                            ...
                            <div className="d-flex align-items-center gap-1"><i className='bx bxs-bus' style={{ fontSize: "22px" }}></i> Marcopolo G8 - 1500</div>
