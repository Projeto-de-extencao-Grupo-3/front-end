...
function PgtoPendente() {
    const paginaAtual = "analisar1";
        ...
        <Layout ativo={"painel"}>
            ...
            <StepperFluxo
                etapas={[
                    ...
                    { id: "pgtorealizado", label: "Pagamento Realizado", icon: "bx bx-time", status: "pendente" },
                    { id: "nfgerada", label: "Nota fiscal gerada", icon: "bx bx-lock", status: "pendente" }
                ]}
            />
